function gst = ur5FwdKin(q)
    ...
    1/4*(4*l0 + 4*l1*cos(th2) + 4*l2*cos(th2+th3) + 4*l4*cos(th2+th3+th4) + 2*l5*cos(th2+th3+th4-th5) - ...
    2*l5*cos(th2+th3+th4+th5) + 46*cos(th2+th3+th4-th6) - 2*l1*cos(th2+th3+th4-th6) - ...
    2*l2*cos(th2+th3+th4-th6) - 23*cos(th2+th3+th4-th5-th6) + l1*cos(th2+th3+th4-th5-th6) + ...
    l2*cos(th2+th3+th4-th5-th6) - 23*cos(th2+th3+th4+th5-th6) + l1*cos(th2+th3+th4+th5-th6) + ...
    l2*cos(th2+th3+th4+th5-th6) + 46*cos(th2+th3+th4+th6) - 2*l1*cos(th2+th3+th4+th6) - ...
    2*l2*cos(th2+th3+th4+th6) + 23*cos(th2+th3+th4-th5+th6) - l1*cos(th2+th3+th4-th5+th6) - ...
    l2*cos(th2+th3+th4-th5+th6) + 23*cos(th2+th3+th4+th5+th6) - l1*cos(th2+th3+th4+th5+th6) - ...
    l2*cos(th2+th3+th4+th5+th6));

    0, 0, 0, 1
    ];
    % 
    % gst = gst - [0.0000    0.0000   -0.0000   -0.0000;
    %              0.0000    1.0000   -1.0000   -0.1915;
    %              0.0000    1.0000    1.0000   -1.0011;
    %              0         0         0         0];
end
